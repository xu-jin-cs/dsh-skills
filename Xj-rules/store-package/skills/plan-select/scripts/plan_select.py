...
ATTACHED_DISPATCH = os.path.expanduser("~/.agents/skills/plan-select/scripts/attached_dispatch.py")
ATTACHED_PLAN = os.path.expanduser("~/.agents/skills/plan-select/scripts/attached_plan.py")

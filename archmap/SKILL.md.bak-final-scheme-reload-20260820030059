...
<!-- 由 dispatcher_generate.py 全量维护，勿手改；最近注入: 2026-08-20T02:58:55.902819 -->
...
- 🟡 **retro-archmap-005-触发信号archmap-测绘含部署副本镜像代理转发目录的项目时-共享-**｜触发词: 收集合法api / api路由集合｜Auto-generated from retro [archmap×agent-harness 2026-08-15

...
<!-- 由 dispatcher_generate.py 全量维护，勿手改；最近注入: 2026-08-21T18:20:45.798700 -->
...
> 1. 读取 `~/.agents/skills/archmap/learned-skills/registry.json`；
...
<!-- 共 5 条（领域 4 / 专项 1）；全文见 ~/.agents/retro-skills-registry/skills/<skill_id>/SKILL.md；技能表见 learned-skills/registry.json -->
